...
export default function AddRouteScreen() {
  ...
  // Dummy suggested routes data
  const dummyRoutes: SuggestedRoute[] = [
    {
      id: '1',
      name: 'Central Park Loop',
      description: 'A scenic route through Central Park with beautiful landscapes and historic landmarks.',
      distance: '3.2 miles',
      duration: '45 minutes',
      cost: '$15',
      ...
      landmarks: [
        { id: 'A', name: 'Bethesda Fountain', description: 'Iconic fountain and terrace' },
        { id: 'B', name: 'Bow Bridge', description: 'Cast-iron bridge with views' },
        { id: 'C', name: 'Strawberry Fields', description: 'John Lennon memorial' }
      ],
      landmarkTransportation: [
        { from: 'A', to: 'B', mode: 'figure.walk', label: 'Walking' },
        { from: 'B', to: 'C', mode: 'bicycle', label: 'Cycling' }
      ]
    },
    {
      id: '2',
      name: 'Downtown Architecture Tour',
      description: 'Explore stunning architecture of downtown with historical buildings and modern skyscrapers.',
      distance: '2.8 miles',
      duration: '1 hour',
      cost: '$10',
      transportModes: ['Walk', 'Public Transport'],
      themes: ['New Buildings', 'Ancient Buildings'],
      landmarks: [
        { id: 'A', name: 'City Hall', description: 'Historic government building' },
        { id: 'B', name: 'Glass Tower', description: 'Modern architectural marvel' },
        { id: 'C', name: 'Old Library', description: 'Renaissance revival style' }
      ],
      landmarkTransportation: [
        { from: 'A', to: 'B', mode: 'figure.walk', label: 'Walking' },
        { from: 'B', to: 'C', mode: 'bus.fill', label: 'Bus' }
      ]
    },
    {
      id: '3',
    ...
    },
    {
      ...
      landmarkTransportation: [
        { from: 'A', to: 'B', mode: 'figure.walk', label: 'Walking' },
        { from: 'B', to: 'C', mode: 'tram.fill', label: 'Tram' }
      ]
    },
    {
      id: '5',
      ...
      landmarkTransportation: [
        { from: 'A', to: 'B', mode: 'figure.walk', label: 'Walking' },
        { from: 'B', to: 'C', mode: 'car.fill', label: 'Car' }
      ]
    }
  ];
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setSuggestedRoutes(dummyRoutes);
    }, 3000);
  };
          ...
          {suggestedRoutes.map((route) => (
            ...
            >
              ...
              <View style={styles.mapPlaceholder}>
                <IconSymbol size={32} name="map.fill" color="#8900e1" />
